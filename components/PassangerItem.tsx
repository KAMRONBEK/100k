      ...
      >
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          >
            <Image
              source={images.seat}
              style={{ width: 25, height: 25, tintColor: "#000", marginTop: 1 }}
            />
            <Text
              style={{
                fontSize: 17,
        ...
        <View>
          <Text
            style={{ fontSize: 15, marginTop: 12, opacity: 0.7, color: "gray" }}
          >
            {item.note}
          </Text>
          <View
          ...
          >
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              />
              <Text style={{ marginLeft: 5, marginBottom: 5, opacity: 0.7 }}>
                0
              </Text>
            </View>
          </View>
        ...
        >
          <View style={styles.borderBottom}>
            ...
            <View>
              <Text
                style={{ marginLeft: 10, color: "gray", fontWeight: "500" }}
              >
                {!!item.creator_name ? item.creator_name : "Anonim"}
              </Text>
              <Text
                style={{ marginLeft: 10, color: "gray", fontWeight: "600" }}
              >
                {item.created_at}
              </Text>
            </View>
