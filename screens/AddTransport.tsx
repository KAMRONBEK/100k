...
const AddTransport = ({ navigation }) => {
    ...
    const [nonee, setNonee] = useState<"none" | "flex">("none");
    const Handle = () => {
        setColor("#556080");
        setColorOne("#bfbfbf");
        setColorTwo("#bfbfbf");
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Image
                        ...
                        source={require("../assets/carOne.png")}
                    />
                ...
                >
                    <Image
                        style={{ tintColor: colorOne, width: 42, height: 42 }}
                ...
                >
                    <Image
                        style={{ tintColor: colorTwo }}
                        source={require("../assets/frontal-truck.png")}
                    />
                    <Text style={{ color: colorTwo, marginTop: 10 }}>
                        Transport
                    </Text>
                </TouchableOpacity>
            </View>
            <ScrollView
                style={{ marginTop: 22, paddingHorizontal: 16, display: nonee }}
                horizontal={true}
            ...
            >
                <Text
                    style={{ fontSize: 16, marginBottom: 17, color: "#8a8a8a" }}
                >
                    Hozirgi manzilingiz *
                </Text>
                <TouchableOpacity
            ...
            >
                <Text
                    style={{ color: "#8a8a8a", fontSize: 16, marginBottom: 17 }}
                >
            ...
            >
                ...
                <TextInput
                    ...
                    style={[
                        styles.input,
                        { backgroundColor: "#fff", marginBottom: 21 },
                    ]}
                />
