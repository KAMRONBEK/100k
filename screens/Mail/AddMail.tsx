          ...
          >
            ...
            >
                ...
                <TextInput
                    ...
                    keyboardType="default"
                    value={state.info!}
                    onChangeText={(e) => setOrderData({ info: e })}
                />
                <View
                    style={{
                        flexDirection: "row",
                ...
                >
                    <Text
                        onPress={() => setOrderData({ info: "Hujjat" })}
                        style={styles.text}
                    >
                        Hujjat
                    </Text>
                    <Text
                        onPress={() => setOrderData({ info: "Sumka" })}
                        style={styles.text}
                    >
                        Sumka
                    </Text>
                    <Text
                        onPress={() => setOrderData({ info: "Kalit" })}
                        style={styles.text}
                    >
                        Kalit
                    </Text>
                    <Text
                        onPress={() => setOrderData({ info: "Mahsulot" })}
                        style={styles.text}
                    >
                        Mahsulot
                    </Text>
