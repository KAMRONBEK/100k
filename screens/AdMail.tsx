...
const AdMail = ({ navigation }) => {
    ...
    return (
        <ScrollView>
            ...
            <View style={{ marginTop: 32, paddingHorizontal: 16 }}>
                ...
                <View style={{ marginTop: 18, flexDirection: "row" }}>
                    ...
                    <TouchableOpacity
                        ...
                        style={[
                            styles.btn,
                            { marginLeft: 20, backgroundColor: colorOne },
                        ]}
                    >
            ...
            >
                <Text style={{ fontSize: 16 }}>Nma yetqazib berish kerak?</Text>
                <TextInput
                    style={styles.input}
                    keyboardType="default"
                    value={what}
            ...
            >
                ...
                <Text style={{ fontSize: 14, color: "#8a8a8a", marginTop: 13 }}>
                    ...
                    yetarlicha mablag bo’lgan kuryerlarga ko’rsatiladi,
                    mahsulotga yoki jonatmaga zarar yetqazilgan taqdirda
                    reglament boyicha 3 ish kunida ushbu summa tiklab beradi.
                </Text>
            </View>
            <View
                style={{
