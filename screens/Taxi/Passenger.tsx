          ...
          >
            ...
            <View>
              <TouchableOpacity style={styles.btn1}>
                ...
                />
                <Text
                  style={{ marginLeft: 4, fontWeight: "normal", fontSize: 12 }}
                >
                  QABUL QILISH
                </Text>
              </TouchableOpacity>
        ...
        >
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              >
                <Text
                  style={{ color: "#fff", fontSize: 16.33, fontWeight: "600" }}
                >
                  N
                </Text>
              </View>
        ...
        >
          ...
          >
            ...
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <Image
                style={{ width: 23, height: 27.37, marginLeft: 10 }}
                source={require("../../assets/sec2.png")}
              />
            </View>
          </View>
