...
const EditLoad = ({ navigation }) => {
  ...
  useEffect(() => {
    let currentOrder = Object.values(load).filter((item) => item.id == id)[0];
      ...
      <ScrollView>
        ...
        >
          ...
          <View style={{ flexDirection: "row", marginTop: 14 }}>
            <TouchableOpacity
              onPress={() => dispatch(setOrderData({ cost: "500 000" }))}
            >
              <Text style={styles.text}>500 000</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => dispatch(setOrderData({ cost: "1 000 000" }))}
            >
              <Text style={styles.text}>1 000 000</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => dispatch(setOrderData({ cost: "2 000 000" }))}
            >
              <Text style={styles.text}>2 000 000</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => dispatch(setOrderData({ cost: "3 000 000" }))}
            >
